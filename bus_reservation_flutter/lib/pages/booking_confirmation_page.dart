            ...
            Padding(
              ...
              child: TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  filled: true,
                  prefixIcon: Icon(Icons.person, size: 24, color: Colors.teal),
                ),
                validator: (value) {
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  filled: true,
                  prefixIcon: Icon(Icons.call, size: 24, color: Colors.teal),
                ),
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return emptyFieldErrMessage;
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  filled: true,
                  prefixIcon: Icon(Icons.email, size: 24, color: Colors.teal),
                ),
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return emptyFieldErrMessage;
